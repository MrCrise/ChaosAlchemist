from src.components import Transform, Velocity, State, Sprite
...
class StateSystem(System):
    ...
    def update(self, dtime: float) -> None:
        for entity in self.entities:
            ...
            new_state = current_state.update(entity, dtime)
...
class MovementSystem(System):
    ...
    def update(self, dtime: float) -> None:
        for entity in self.entities:
            ...
            transform.rect.center += velocity.direction * velocity.speed * dtime
